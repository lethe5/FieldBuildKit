    ...
    ColumnLayout {
        ...
        Item {
            ...
            ScrollView {
                ...
                FloatingComboBox {id:scopeCombo;objectName:"scopeCombo";floatingLabel:"계산 대상";model:["선택 대상","전체 대상","미조사 대상"];Layout.fillWidth:true;Layout.maximumWidth:routeScroll.availableWidth-24;onActivated:panel.refreshTargets()}
                ...
                FloatingComboBox {id:startCombo;objectName:"startCombo";floatingLabel:"출발지";model:["현재 GPS 출발","지도 위치 출발","조사지 출발","저장 기본 출발지"];Layout.fillWidth:true;Layout.maximumWidth:routeScroll.availableWidth-24;onCurrentIndexChanged:{if(currentIndex!==1)panel.clearStartMarker();}onActivated:{panel.refreshTargets();panel.validateStart();}}
                ...
                Button {id:settingsDisclosure;objectName:"settingsDisclosure";text:(panel.settingsExpanded?"▾ ":"▸ ")+"API URL/키 설정";Layout.fillWidth:true;Layout.maximumWidth:routeScroll.availableWidth-24;Accessible.name:"API URL/키 설정";Accessible.description:panel.settingsExpanded?"expanded":"collapsed";onClicked:panel.settingsExpanded=!panel.settingsExpanded}
                ColumnLayout {
                ...
                Label {objectName:"coordinateSharingNotice";text:"계산하면 원본 조사 좌표, 반환된 차량 접근 좌표와 경로 geometry 요청이 ORS에 전송됩니다.";Accessible.name:text;Accessible.role:Accessible.StaticText;wrapMode:Text.Wrap;Layout.fillWidth:true;Layout.maximumWidth:routeScroll.availableWidth-24}
