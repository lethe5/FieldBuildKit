...
| AC-SRP-058 | `ac058_route_line_toggle_is_one_atomic_settings_only_write_and_persists`; `ac058_preview_and_legend_are_write_free`; `ac058_toggle_failure_rolls_back_and_reports_actionable_feedback` (write/readback) | M03/M19 native QField persistence/rendering remains NOT RUN |
